...
5. Polish → cross-cutting error/empty/override/regression coverage, typecheck/full suites, `project-docs/GRAMMAR.md` extension, manual quickstart, `CLAUDE.md` audit.
...
`project-docs/ARCHITECTURE.md`, and `.specify/memory/constitution.md` (a real
